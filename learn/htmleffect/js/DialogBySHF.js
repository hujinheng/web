;(function ($) {
    //默认参数
    var PARAMS;
    var DEFAULTPARAMS = { Title: "提示", Content: "", Width: 400, Height: 300, URL: "", ConfirmFun: new Object, CancelFun: new Object };
    var ContentWidth = 0;
    var ContentHeight = 0;
    $.DialogBySHF = {
        //弹出提示框
    ...
    function Init(params) {
        if (params != undefined && params != null) {
            //$.extend是将DEFAULTPARAMS 和 params进行合并 成为第一个参数 
            //并且后面的params会覆盖前面DEFAULTPARAMS相同参数
